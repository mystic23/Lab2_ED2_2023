...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.appearance_mode_optionemenu.grid(row=7, column=0, padx=(20, 20), pady=(20, 0))
        ...
        self.button_8.grid(row=0, column=2, sticky="w", padx=(5, 0), pady=12)
    ...
    def show_routes(self):
        ...
        try:
            ...
            self.airport = self.grafo[self.address]
            for ady in self.airport.routes.keys():
                path = self.map_widget.set_path([self.airport.coords,self.grafo[ady].coords],color="blue",width=4)
        except:
            self.consola.config(text="introduzca pais con marcador")
    ...
    def delete_airport(self):
        ...
        try:
            self.address = self.address_box.get()
            self.grafo.deleteAirport(self.address)
            self.markers_dict[self.address].delete()
            self.map_widget.delete_all_path()
        except:
            self.consola.config(text="Escriba pais en mapa")
